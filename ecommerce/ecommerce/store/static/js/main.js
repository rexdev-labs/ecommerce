...
(function ($) {
 ...
 /*----------------------------
    ...
    CartPlusMinus.prepend('<div data-product="{{ item.product.id }}" data-action="add" class="dec qtybutton update-cart">-</div>');
    CartPlusMinus.append('<div data-product="dataproduct" data-action="remove"  class="inc qtybutton update-cart">+</div>');
